...
TEST(SortTestSet, SelectionSortVectorContainerTest) {
    Op* seven = new Op(7);
    Op* four = new Op(4);
...
TEST(SortTestSet, SelectionSortVectorContainerTest2) {
...
TEST(SortTestSet, SelectionSortListContainerTest) {
    Op* seven = new Op(7);
    Op* four = new Op(4);
    Mult* TreeA = new Mult(seven, four);
...
TEST(SortTestSet, SelectionSortListContainerTest2) {
    Add* TreeA  = new Add(new Op(6), new Op(2));
    Div* TreeB  = new Div(new Op(6), new Op(2));
    Mult* TreeC = new Mult(new Op(6), new Op(2));
    Op* TreeD   = new Op(6);
