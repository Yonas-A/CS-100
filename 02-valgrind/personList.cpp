...
PersonList::~PersonList(){
    for ( int i = 0; i < capacity; i++ )
        delete  theList[i]; // need to delete persons inside List
	// delete invokes Person::~Person() delete each Person
    delete [] theList; // delete itself since it was created using new
}
